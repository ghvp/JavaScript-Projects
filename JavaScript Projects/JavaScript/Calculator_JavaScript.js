...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second)=_Operand is true and sets Display_Value
...
function Handle_Operator(Next_Operator) {
    ...
    //Then operates the operator and exits from the function
    ...
    } else if (operator) {//checks if an operation already exists 
